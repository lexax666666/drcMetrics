    ...
    <nav className="sticky top-0 z-50 bg-[var(--static-background-strong)] border-b border-[var(--static-divider-standard)]">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a href="#features" className="text-[var(--static-text-standard)] hover:text-[var(--static-text-strong)] no-underline">
            Features
          </a>
          <a href="#pricing" className="text-[var(--static-text-standard)] hover:text-[var(--static-text-strong)] no-underline">
            Pricing
          </a>
          <a href="#demo" className="text-[var(--static-text-standard)] hover:text-[var(--static-text-strong)] no-underline">
            Demo
          </a>
          <div className="flex items-center space-x-4">
            <a href="/login" className="text-[var(--static-text-standard)] hover:text-[var(--static-text-strong)] no-underline">
              Log in
            </a>
